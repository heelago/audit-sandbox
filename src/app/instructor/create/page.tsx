...
const SUB_STEPS: SubStepDef[] = [
  ...
  },
  {
    ...
    example: [
      'למשל: "נתחו את הטענה לפי שני מקורות קורס ובצעו השוואה ביקורתית."',
      'או: "זהו בעיות מתודולוגיות בדו״ח המחקר והציעו תיקונים מנומקים."',
      'או: "הערכת מדיניות — בחנו שתי גישות מתחרות וקבעו עמדה מנומקת."',
    ],
    impactLabels: ['יצירת טקסט ✓', 'ביקורת ✓'],
  },
  // Step 1: Planted Signals
  {
    ...
    example: [
      '״קפיצה סיבתית״ — הטקסט יטען שתופעה מורכבת נובעת מסיבה אחת בלבד.',
      '״פסקה רהוטה אך ריקה״ — פסקה שנשמעת אקדמית אך לא תורמת תוכן ממשי.',
      '״מקור מומצא״ — ציטוט ממחקר שלא קיים, כדי לתרגל אימות ביבליוגרפי.',
    ],
  ...
  },
  {
    ...
    example: [
      'למשל: חלק 1 — "סכמו את הטענה המרכזית בשלושה משפטים"',
      'חלק 2 — "השוו את עמדת המחבר לגישה מתחרת מהקורס"',
      'בכל חלק אפשר להגדיר משימה מוקדת שמכוונת את הסטודנט/ית.',
    ],
    impactLabels: ['יצירת טקסט ✓', 'ביקורת ✓'],
  },
  {
    ...
    example: [
      'קריטריון טוב: "ביסוס הטענה המרכזית בשני מקורות שונים לפחות"',
      'קריטריון טוב: "הצגת הסתייגות מתודולוגית אחת לפחות"',
      'קריטריון מעורפל (נסו להימנע): "כתיבה ברמה גבוהה" — לא ברור מה בודקים.',
    ],
    impactLabels: ['יצירת טקסט ✓', 'ביקורת ✓'],
  },
  // Step 2: Settings
  {
    ...
    example: [
      'שגיאות מאוזנות: הטקסט ייראה אמין אך יכלול 3-6 כשלים מכוונים שהסטודנטים צריכים לזהות.',
      'טבעי: טקסט סביר ללא כשלים מכוונים — מתאים למטלות שלא דורשות זיהוי שגיאות.',
      'אמת קפדנית: טקסט מדויק ככל האפשר — לתרגילי הבנה והשוואה.',
    ],
  ...
  },
  {
    ...
    example: [
      'אפשר להדביק מספר מקורות, בעברית או באנגלית:',
      'Kahneman, D. (2011). Thinking, Fast and Slow. Farrar, Straus and Giroux.',
      'שגיא, א. (2018). אתגר השיבה אל המסורת. שלם.',
    ],
    impactLabels: ['יצירת טקסט ✓', 'ביקורת ✓'],
  },
  {
